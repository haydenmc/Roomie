...
var Pad = (function (_super) {
    ...
    function Pad(pad_id, pad_name) {
        ...
        chatPane.innerHTML = '<h1 class="listTitle"><div class="gradient"></div>Chat</h1>' + '<ul class="chatlist" ></ul>' + '<form class="messageEntry" >' + '<input type="text" name="body" placeholder ="type your message" autocomplete="off" autocorrect="on" autocapitalize="on" />' + '<input type="submit" value="Send" /></form>';
